...
//    unsigned long long eventIndex = [[_beats objectForKey:[NSNumber numberWithLong:pageIndex]];
//}
//
...
{
    [_constantBeats replaceBytesInRange:NSMakeRange(index * sizeof(BeatEvent), sizeof(BeatEvent))
                              withBytes:event];
}
